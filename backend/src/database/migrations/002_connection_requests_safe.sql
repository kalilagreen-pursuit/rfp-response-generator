-- ============================================================================
-- CONNECTION REQUESTS TABLE (Safe Migration - No DROP statements)
-- ============================================================================
...
--
-- This version uses DO blocks to check if policies exist before creating them
-- This avoids Supabase warnings about DROP statements
...
-- Indexes for faster lookups (IF NOT EXISTS is implicit for indexes)
